...
namespace PraiseBase.Presenter.Persistence.OpenLyrics
{
    public class OpenLyricsSong : ISongFile
    {
        ...
        public class Verse : ICloneable
        {
            ...
            {
                return string.Equals(Name, other.Name) && string.Equals(Language, other.Language) && string.Equals(Transliteration, other.Transliteration) && Equals(Lines, other.Lines);
            }
